...
2. Export your OpenAI API key:
   ```
   export OPENAI_API_KEY=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
   ```
